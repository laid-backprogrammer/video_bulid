...
export function makeVisualDirectorSystemPrompt() {
  return [
    ...
    '8. Required Asset Plan',
    '9. Avoid Generic Layouts',
    'Preserve colors, named objects, pacing phases, transitions, and subtitle constraints from the brief.',
    'If tuningNotes conflict with designNotes, explicitly name the tuningNotes choice as the one to follow.',
    'For each required media asset, include its id/alias, render type, placement/timing if stated, and how the code should select it by id or alias.',
